...
This document outlines the processes and practices recommended for contributing enhancements to `oidc-gatekeeper`.
...
# Deploy the charm
juju deploy ./oidc-gatekeeper_ubuntu-20.04-amd64.charm \
